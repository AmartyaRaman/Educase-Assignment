...
const Home = () => {
  return (
    <div className='flex p-5 h-screen w-full items-center justify-center'>
      <div className='bg-gray-50 flex flex-col-reverse w-sm h-full py-12 px-8 border border-gray-300'>
        <button className='bg-[rgb(208,188,252)] p-2 font-medium rounded-md w-full mt-2'>Already Registered? Login</button>
